...
LANG = "EN_STREUSLE"		    	# specify the name of the language (i.e. EN|FR|FA|DE)
MODEL = "model_Att_Based_glove"		# specify the name of the training model to be used (models are defined in rnn_models.py)
